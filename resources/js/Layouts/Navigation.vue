<template>
    ...
    <div :class="$page.props.showingMobileMenu ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
        ...
        <nav class="mt-10" x-data="{ isMultiLevelMenuOpen: false }">
            ...
            <nav-link :href="route('dependencies.index')" :active="route().current('dependencies.index')">
                <i class="fa-solid fa-building"></i>
                Dependencias
            </nav-link>

            <nav-link :href="route('computers.index')" :active="route().current('computers.index')">
